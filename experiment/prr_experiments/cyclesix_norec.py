"""
Run the Cycle 6 PRR experiment without local screen-recorder capture.
...
Expected output:
    Opens consent and Cycle 6 pages, starts configured MediaMTX paths after
    consent, opens the Ampara PDF, and keeps the browser workflow active.
"""
